        ...
        axios.get(`/user/${userID}/myevents`)
            .then((response) => {
                ...
                for (let i = 0; i < arrayOfEvents.length; i++) {
                    // you are signed up for the event and the organizer:
