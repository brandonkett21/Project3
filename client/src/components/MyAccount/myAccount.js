                                    ...
                                    <div className="col s12">
                                        ...
                                        <div className="card-content">
                                            ...
                                            <div className="collection">
                                                <a className="collection-item"><span className=""></span><b>First Name :</b> {props.firstname}</a>
                                                <a className="collection-item"><span className=""></span><b>Last Name :</b> {props.lastname}</a>
                                                <a className="collection-item"><span className=""></span><b>Email :</b> {props.email}</a>
                                            </div>
                                            <div className="row">
                                                <div className="input-field col s6">
                                                    <input id="firstname" type="text" className="validate" name="newfirstname" onChange={props.handleInputChange}/>
                                                    <label htmlFor="firstname">New First Name</label>
                                                </div>
                                                <div className="input-field col s6">
                                                    <input id="lastname" type="text" className="validate" name="newlastname" onChange={props.handleInputChange}/>
                                                    <label htmlFor="lastname">New Last Name</label>
                                                </div>
                                            </div>
                                            <div className="row">
                                                <div className="input-field col s6">
                                                    <input id="email" type="email" className="validate" name="newemail" onChange={props.handleInputChange}/>
                                                    <label htmlFor="email">New Email</label>
                                                </div>
                                                <div className="input-field col s6">
                                                    <input id="newPassword" type="password" className="validate" name="newpassword" onChange={props.handleInputChange}/>
