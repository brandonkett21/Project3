              ...
              <form className="col s12">
                <div className="row">
                  <div className="col s12">
                    ...
                    <br></br>
                    <span className="card-title" style={{ fontSize: "1rem", color: "green" }}>
                      <i>{props.admin === true ? "*Note:  You are the organizer for this event!  Editing this event's details can be done below.": ""}</i>
                    </span>
                    <br></br>
                    ...
                    <div className="card-content">{props.editing === true ? (
                        <div className="collection">
                          ...
                          <Autocomplete color={"lightgoldenrodyellow"}></Autocomplete>

                          <a className="collection-item">Change Event Date from <b>{props.date}</b> to:</a>
                          <input id="date" type="date" className="validate" name="newdate" onChange={props.handleInputChange}/>
                          <label htmlFor="date"></label>

                          <a className="collection-item">Change Event Time from <b>{props.time}</b> to:</a>
                          <input id="time" type="time" className="validate" name="newtime" onChange={props.handleInputChange}/>
                          <label htmlFor="time"></label>

                          <a className="collection-item">Change Event Description from{" "}
                            <b>{props.description}</b> to:{" "}
                            <input id="description" type="text" className="validate" name="newdescription" onChange={props.handleInputChange}/>
                            <label htmlFor="description"></label>
                          </a>

                          <a className="collection-item">Change Event Image{" "}
                            <div className="col s12">
                              <form action="#">
                          ...
                          <textarea id="description" class="materialize-textarea" name="newdescription" onChange={props.handleInputChange}></textarea>
